...
- **계획:** `docs/IMPLEMENTATION_PLAN.md` **v1.19** (Insight promote+index · feedback · ops · worker)
...
`docs/IMPLEMENTATION_PLAN.md` **v1.19** — Insight approve/promote/index · feedback · worker jobs · load smoke · ops.
