...
- **홈 Claude MCP 연결 안내** — `location.hostname` 기반 CLI/JSON 자동 생성, 클립보드 API 폴백
- **헤더/타이포 리비주얼** (`apps/web/public/css/theme.css`) — 다크 헤더 · SDS 블루 `#1428A0` · Pretendard/JetBrains Mono 로컬 벤더 폰트(`apps/web/public/fonts/`, CDN 無)
